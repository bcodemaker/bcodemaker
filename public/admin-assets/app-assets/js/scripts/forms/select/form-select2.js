...
(function(window, document, $) {
  ...
  // Basic Select2 select
    ...
    $(".select2-placeholder-multiple").select2({
     ...
     // Multiple Select Placeholder
    $(".select2-placeholder-fee-month").select2({
      placeholder: "Fee Month"
    });

     $(".select2-placeholder-subject-teacher").select2({
  ...
  $(document).ready(function() {
     $("#country").select2({
      ...
      $('#select2-country-container .select2-selection__placeholder').html('Select Country');
    });
   ...
   $(document).ready(function() {
     $("#state").select2({
      ...
      $('#select2-state-container .select2-selection__placeholder').html('Select State');
    });
     ...
     $("#city").select2({
      ...
      $('#select2-city-container .select2-selection__placeholder').html('Select City');
    });
