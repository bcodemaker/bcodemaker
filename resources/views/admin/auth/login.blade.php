...
<head>
  ...
  <link href="{{asset(App\Models\SiteSetting::latest()->value('favicon'))}}" rel="icon">
  <link href="{{asset(App\Models\SiteSetting::latest()->value('favicon'))}}" rel="apple-touch-icon">
          ...
          <div class="card border-grey border-lighten-3 px-2 py-2 row mb-0">
            ...
            <div class="card-header border-0" style="padding: 0">
              <div class="card-title text-center">
                <img style="max-height: 85px;" src="{{asset(\App\Models\SiteSetting::latest()->value('logo'))}}" alt="{{App\Models\SiteSetting::latest()->value('site_title')}}">
              </div>
