                    ...
                    <table id="dataTableAjax" class="table display dataTableAjax table-striped table-bordered scroll-horizontal dataTable no-footer" >
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                @can(['edit_die_cutting','delete_die_cutting','browse_die_cutting','change_status_die_cutting'])
  ...
  //alert('hello');  
            ...
            var table2 = $('#dataTableAjax').DataTable({
                ...
                { "data": "sn" },
                    ...
                    @can(['edit_die_cutting','delete_die_cutting','read_die_cutting','change_status_die_cutting'])
                        ...
                        render: function(data, type, row) {
                            ...
                            if (type === 'display') {
                                ...
                                if( row['username'] != null ){
                                    ...
                                    if(row['current_admin_id'] == row['admin_id'] || row['role_id'] == 1 || row['role_id'] == 2){
                                    ...
                                    if( row['changeStatus']=='2' || row['changeStatus']=='3' ){
                                        ...
                                        btn+='<button type="button" onclick="updateData(\'{{ route('admin.'.request()->segment(2).'.changeStatus') }}\',{id:'+row['id']+',project_id:'+row['project_id']+',status:1})" class="btn btn-social-icon btn-outline-info btn-xs" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="End Job"><i class="ft-check-square"></i></button> ';
                                        ...
                                        btn+='<button type="button" onclick="selectedJob(\''+row['username']+'\')" class="btn btn-social-icon btn-outline-danger btn-xs" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Job Is Select By '+row['username']+'"><i class="fa fa-play-circle-o"></i></button> ';
                                    ...
                                    btn+='<button type="button" onclick="updateData(\'{{ route('admin.'.request()->segment(2).'.changeStatus') }}\',{id:'+row['id']+',status:1,start_job:1})" class="btn btn-social-icon btn-outline-secondary btn-xs" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Start Job"><i class="ft-pause-circle"></i></button> ';
            ...
            function selectedJob(data){

                toastr.error('Job is already selected by: '+data);

                //Command: toastr['danger']('ggjv');
