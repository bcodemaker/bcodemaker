                    ...
                    <table id="dataTableAjax" class="table display dataTableAjax table-striped table-bordered scroll-horizontal dataTable no-footer" >
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                @can(['edit_heidelberg_1','delete_heidelberg_1','browse_heidelberg_1','assign_heidelberg_1','edit_heidelberg_2','delete_heidelberg_2','browse_heidelberg_2','assign_heidelberg_2'])
...

                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            if (type === 'display') {
                                ...
                                @can(['change_status_heidelberg_1','change_status_heidelberg_2'])
                                ...
                                @can(['read_heidelberg_1','read_heidelberg_2'])
                                ...
                                @can(['edit_heidelberg_1','edit_heidelberg_2'])
                                ...
                                @can(['delete_heidelberg_1','delete_heidelberg_1'])
