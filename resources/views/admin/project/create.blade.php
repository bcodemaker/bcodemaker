               ...
               <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                        <div class="form-group{{ $errors->has('carton_name') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('carton_name', null, ['class' => 'form-control', 'placeholder' => 'Carton Name']) !!}
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                        <div class="form-group{{ $errors->has('carton_quantity') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('carton_quantity', null, ['class' => 'form-control', 'placeholder' => 'Carton Quantity']) !!}
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="form-group{{ $errors->has('printing_machine') ? ' has-error' : '' }}">
                                ...
                                {!! Form::select('printing_machine',['heidelberg1'=>'Heidelberg-1','heidelberg2'=>'Heidelberg-2','dominent'=>'Dominent'], null, ['class' => 'form-control', 'placeholder' => 'Select Printing Machine']) !!}
